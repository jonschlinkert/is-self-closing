# Contributing to is-self-closing

First and foremost, thank you! We appreciate that you want to contribute to is-self-closing, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for is-self-closing**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for is-self-closing:

- star the [project](https://github.com/jonschlinkert/is-self-closing)
- tweet your support for is-self-closing
...
- **version**: please note the version of is-self-closing are you using
...
[so]: http://stackoverflow.com/questions/tagged/is-self-closing